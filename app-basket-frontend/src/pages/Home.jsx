    ...
    <div className="flex flex-col min-h-screen bg-bg-light dark:bg-bg-dark text-blue-text dark:text-text-primary-dark">
      ...
      <main className="flex flex-col flex-1 items-center justify-center p-7 text-center bg-bg-light dark:bg-bg-dark">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-6">
          <Link
            to="/accueil"
            className="flex min-w-[240px] items-center justify-center rounded-xl h-14 px-8 bg-orange-basket text-white text-lg font-bold shadow-lg shadow-orange-basket/20 hover:shadow-orange-basket/40 hover:-translate-y-1 transition-all"
          >
